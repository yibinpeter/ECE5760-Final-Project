	Computer_System u0 (
		.axi_pio_lw_ifm_curr_external_connection_export    (<connected-to-axi_pio_lw_ifm_curr_external_connection_export>),    //    axi_pio_lw_ifm_curr_external_connection.export
		.axi_pio_lw_ifm_done_external_connection_export    (<connected-to-axi_pio_lw_ifm_done_external_connection_export>),    //    axi_pio_lw_ifm_done_external_connection.export
		.axi_pio_lw_ifm_wr_addr_external_connection_export (<connected-to-axi_pio_lw_ifm_wr_addr_external_connection_export>), // axi_pio_lw_ifm_wr_addr_external_connection.export
		.axi_pio_lw_ready_external_connection_export       (<connected-to-axi_pio_lw_ready_external_connection_export>),       //       axi_pio_lw_ready_external_connection.export
		.axi_pio_lw_thr_out_external_connection_export     (<connected-to-axi_pio_lw_thr_out_external_connection_export>),     //     axi_pio_lw_thr_out_external_connection.export
		.axi_pio_lw_valid_external_connection_export       (<connected-to-axi_pio_lw_valid_external_connection_export>),       //       axi_pio_lw_valid_external_connection.export
		.axi_pio_lw_wet_curr_external_connection_export    (<connected-to-axi_pio_lw_wet_curr_external_connection_export>),    //    axi_pio_lw_wet_curr_external_connection.export
		.axi_pio_lw_wet_wr_addr_external_connection_export (<connected-to-axi_pio_lw_wet_wr_addr_external_connection_export>), // axi_pio_lw_wet_wr_addr_external_connection.export
		.axi_pio_main_low_out_external_connection_export   (<connected-to-axi_pio_main_low_out_external_connection_export>),   //   axi_pio_main_low_out_external_connection.export
		.axi_pio_mainhigh_out_external_connection_export   (<connected-to-axi_pio_mainhigh_out_external_connection_export>),   //   axi_pio_mainhigh_out_external_connection.export
		...
		.axi_pio_lw_buf_ack_external_connection_export     (<connected-to-axi_pio_lw_buf_ack_external_connection_export>)      //     axi_pio_lw_buf_ack_external_connection.export
	);
